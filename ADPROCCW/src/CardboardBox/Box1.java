/**
 *  <h1>Box1</h1> 
 *  <p>This is a box of type 1, the type of box based on Swing inputs will be determined by an outside class.</p>
 */
...
public class Box1 extends Box {
    ...
    public String getInfo(){
        return "Type 1 Box - Area: " + super.getBoxArea() + ", Cardboard Grade: " + boxGrade + 
            ", Colours: " + boxColours + ", Sealable Top: " + boxSealableTop + ", Reinforced Bottom: "
            + boxReinforcedBottom + ", Reinforced Corners: " + boxReinforcedCorners + ". Total Price: 
            £" + getPrice();
    }
